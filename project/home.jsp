...
<html>
<head>
	<title>Cervix Cancer Predictor</title>
	<meta charset="utf-8">
...
<div id="registration" class="container text-center" style="background-image: url(background.jpg); width: 100%; height:1000px;">
     <%
    ...
    %> 
		<div class="card">
			<div class="header">
					<h1 style="color: blue;"><font size="10px"><strong>Register Now</font></h1><font size="5px;">We care about you</font></p>
				</div>
<div class="containr">
	<form name="Register" onsubmit="return validation()" method="post" action="registration.jsp" style="padding-left: 20px; padding-right: 20px;">
		<div class="form-group">
...
<footer class="text-center">
  ...
  <a href="contact1.jsp"><p font size="4" style="display: inline-block; float: right;
